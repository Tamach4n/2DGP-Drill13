        ...
        self.state_machine.set_transitions(
            {
                ...
                RunRight: {
                    right_up: Idle,
                    left_down: Idle,
                    upkey_down: RunRightUp,
                    upkey_up: RunRightDown,
                    downkey_down: RunRightDown,
                    downkey_up: RunRightUp,
                },
                RunRightUp: {
                    upkey_up: RunRight,
                    right_up: RunUp,
                    left_down: RunUp,
                    downkey_down: RunRight,
                },
                RunUp: {
                    upkey_up: Idle,
                    left_down: RunLeftUp,
                    downkey_down: Idle,
                    right_down: RunRightUp,
                    left_up: RunRightUp,
                    right_up: RunLeftUp,
                },
                RunLeftUp: {
                    right_down: RunUp,
                    downkey_down: RunLeft,
                    left_up: RunUp,
                    upkey_up: RunLeft,
                },
                RunLeft: {
                    left_up: Idle,
                    upkey_down: RunLeftUp,
                    right_down: Idle,
                    downkey_down: RunLeftDown,
                    upkey_up: RunLeftDown,
                    downkey_up: RunLeftUp,
                },
                RunLeftDown: {
                    left_up: RunDown,
                    downkey_up: RunLeft,
                ...
                RunDown: {
                    downkey_up: Idle,
                    left_down: RunLeftDown,
                    upkey_down: Idle,
                    right_down: RunRightDown,
                    left_up: RunRightDown,
                    right_up: RunLeftDown,
                },
                RunRightDown: {
                    right_up: RunDown,
                    downkey_up: RunRight,
